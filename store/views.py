...
#
#
#     # thrushold = timezone.now().date()  + timedelta(days=4)
#     # get_products = Item.objects.filter(expiring_date=thrushold)
#     # if get_products:
#     #    unread_notifications_count = Notification.objects.filter(read=False)
#     #    if unread_notifications_count:
#     #        unread_notifications_counts=unread_notifications_count.count
#     #    else:
#     #        msg='created'
#     #        notification = Notification.objects.create(message=msg,read=False)
#     #        notification.save()
#     #        unread_notifications_counts=notification.count
#
#
#
