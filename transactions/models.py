...
class Sale(models.Model):
    ...
    amount_received = models.FloatField(default=False, blank=True, null=True)
    balance = models.FloatField(default=False, blank=False, null=False)
    profile = models.ForeignKey(Profile, verbose_name=('Served by'), on_delete=models.CASCADE,blank=True, null=True)
...
# for adding customer purchased products for billing
