...
def delete_bill_single(request,product_name_to_delete):
    billing_instances_to_delete = Billing.objects.filter(sale_item_name=product_name_to_delete)
...
#
#     def test_func(self):
#         purchase = self.get_object().delete
#
#     def test_func(self):
